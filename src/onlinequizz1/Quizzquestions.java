...
public class Quizzquestions extends JFrame implements ActionListener {
    ...
    Quizzquestions(String name) {
        this.name = name;
        setBounds(50, 0, 1440, 850);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/middileimage.png"));
        ...
        if (ae.getSource() == next) {
            ...
            if (group_options.getSelection() == null) {
               useranswers[count][0] = "";
                ...
                useranswers[count][0] = group_options.getSelection().getActionCommand();
            }
